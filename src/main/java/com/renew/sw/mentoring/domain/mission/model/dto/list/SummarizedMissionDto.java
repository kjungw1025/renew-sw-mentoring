...
@Getter
public class SummarizedMissionDto {
    ...
    private final List<ResponseBonusMissionDto> bonusMission;

    public SummarizedMissionDto(Mission mission, List<BonusMission> bonusMissions, MessageSource messageSource) {
        ...
        this.bonusMission = ResponseBonusMissionDto.listOf(bonusMissions);
    }
}
